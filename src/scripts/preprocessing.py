...
def preprocessing(args: Namespace) -> None:
    ...
    joblib.dump(dish_ingredient_train, f"{os.getcwd()}/data/preprocessed/dish_ingredient_train.joblib")
    joblib.dump(dish_ingredient_test, f"{os.getcwd()}/data/preprocessed/dish_ingredient_test.joblib")
    ...
    joblib.dump(user_ingredient_train, f"{os.getcwd()}/data/preprocessed/user_ingredient_train.joblib") # [499 (users), 14548 (ingredients), 10 (num_views))]
    joblib.dump(user_ingredient_test, f"{os.getcwd()}/data/preprocessed/user_ingredient_test.joblib") # [499 (users), 14543 (ingredients), 10 (num_views))]
